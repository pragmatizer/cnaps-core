...
public class AggregateProxy<T extends AggregateRoot> implements AttributeConverter<AggregateProxy, String> {
	...
	private AggregateRelationType relationType = AggregateRelationType.ONE_TO_ONE;
	...
	public AggregateProxy(AggregateRelationType relationType) {
	...
	public void setAggregateRelationType(AggregateRelationType relationType) {
		this.relationType = relationType;
	}
	
	public AggregateRelationType getAggregateRelationType() {
		return relationType;
	}
